...
@interface KFOrderViewController ()<UITableViewDelegate,UITableViewDataSource>
{
...
@implementation KFOrderViewController
...
-(void)actionStateBtn:(UIButton*)btn{
    ...
    if ([btn.titleLabel.text isEqualToString:@"去评论"]) {
