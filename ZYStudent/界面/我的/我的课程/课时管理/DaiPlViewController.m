...
@implementation DaiPlViewController
...
-(UITableViewCell*)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    [cell prepareUI:4];
    [cell.tepyBtn addTarget:self action:@selector(actionTepyBtn:) forControlEvents:UIControlEventTouchUpInside];
    ViewRadius(cell.tepyBtn, 3);
    cell.tepyBtn.backgroundColor = AppMCNACOLOR;
    return cell;
    //    return cell;
...
-(void)actionTepyBtn:(UIButton*)btn{
