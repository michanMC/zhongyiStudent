...
- (void)setFont:(UIFont *)font {
    _font = font;
    self.label.font = font;//[UIFont systemFontOfSize:14];
...
- (void)setText:(NSString *)text {
    ...
    //写死font
    CGRect bounds = [text boundingRectWithSize:CGSizeMake(MAXFLOAT, 0.0) options:NSStringDrawingUsesLineFragmentOrigin attributes:@{NSFontAttributeName: [UIFont systemFontOfSize:20]} context:nil];
